...
"""
Dies ist die Lösung für die einfache Konfiguration.
"""

print() # Leere Zeile
for n,i in enumerate(heuhaufen): # Äußere Liste durchlaufen
    for m,k in enumerate(i): # Jeweils enthaltene Listen durchlaufen
        if k == "Nadel":
            print("Gefunden:",n,m)
            print(heuhaufen[n][m])
            exit()
